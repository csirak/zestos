...
pub fn build(b: *Builder) void {
    ...
    const kernel = b.addExecutable(.{ .name = "kernel", .root_source_file = .{ .path = "kernel/entry.zig" }, .optimize = optimize, .target = target, .linkage = std.build.CompileStep.Linkage.dynamic });
